...
\[Peso 0,5] Utilize a tecla E para remover o vértice mais próximo do polígono selecionado.  
...
\[Peso 1,5] Utilize o teclado S com a posição do mouse para selecionar um polígono (convexo ou côncavo) usando detecção hierárquica filtrando primeiro pela BBox e, se for interno a BBox então testar usando Scan Line (exibir a BBox do polígono selecionado usando a cor amarela).  
