...
namespace gcgcg
{
    internal class Objeto
    {
        ...
        public Shader shaderPonto = new Shader("Shaders/shader.vert", "Shaders/shaderCiano.frag");
        public Shader shaderLinha = new Shader("Shaders/shader.vert", "Shaders/shaderAmarela.frag");
        ...
        public void OnUnload()
        {
            ...
            GL.DeleteProgram(shaderPonto.Handle);
        }
