...
namespace gcgcg
{
  internal class Objeto
  {
    ...
    private PrimitiveType tipoDesenho;

    public Objeto(char rotulo, Objeto paiRef, PrimitiveType tipoDesenho)
    {
      this.rotulo = rotulo;
      this.paiRef = paiRef;
    ...
    public void Atualizar()
    {
      ...
      GL.LineWidth(10);
      _shaderAmarelo = new Shader("Shaders/shader.vert", "Shaders/shaderColorido.frag");
    }
...
// #if CG_OpenGL && !CG_DirectX
      GL.BindVertexArray(_vertexArrayObject_sruEixos);
      _shaderAmarelo.Use();
      GL.DrawArrays(tipoDesenho, 0, pontosLista.Count);
